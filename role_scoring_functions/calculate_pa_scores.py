def calculate_pa_scores(squad_rawdata):
    ...
    squad_rawdata['pa_blue'] = (
                squad_rawdata['Fir'] + squad_rawdata['Hea'] + squad_rawdata['Tec'] + squad_rawdata['Dec'])
    squad_rawdata['pa'] = (
                ((squad_rawdata['pa_key'] * 5) + (squad_rawdata['pa_green'] * 3) + (squad_rawdata['pa_blue'] * 1)) / 28)
